			...
			<div className="container mx-auto px-6">
				<div className="max-w-4xl mx-auto text-center mb-16">
					...
					<p className="text-xl text-gray-600 leading-relaxed">
						We understand that every industry has unique technological
						challenges and requirements. Our specialized IT solutions are
						crafted to address sector-specific needs while maintaining the
				...
				<div className="grid md:grid-cols-2 gap-8 mb-16">
					{solutions.map((solution, index) => (
						<div
							key={index}
							className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2"
						>
							<div
							...
							<div className="relative z-10">
								<div
									className={`text-white mb-6 p-4 rounded-lg bg-gradient-to-r ${solution.gradient} inline-block`}
								>
									{solution.icon}
								</div>
